...
global.owner = process.env.OWNER_NUMBER  || '94701992015' ;  // '255629028037' ;
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=qYFi3AyB#SlsDEW2sp8gkyjGfWhPAfIFWTW1_GwgnIHtEY2mNpws' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "255629028037" : process.env.MODERATORS ,    
